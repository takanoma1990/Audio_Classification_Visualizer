...
const sketch = (p) => {
    ...
    p.preload = () => {
        ...
        soundFile = p.loadSound('music/test.mp3');
    ...
    class Particle {
        ...
        display() {
            ...
            let s = this.size + smoothedBassLevel * 100;
