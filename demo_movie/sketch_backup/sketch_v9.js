...
const sketch = (p) => {
    ...
    p.preload = () => {
        ...
        soundFile = p.loadSound('music/test_v10.mp3');
    ...
    p.setup = async () => {
        ...
        textLayer = p.createGraphics(p.windowWidth, 500);
    ...
    // ★★★ 関数名を drawFlowingImages に変更し、内容を画像描画に差し替え ★★★
